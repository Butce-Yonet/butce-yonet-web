<template>
    <li class="language-nav">
        <div class="translate_wrapper">
            <div class="translate_wrapper " :class="{ 'active': isActive }" @click="display()">
                <div class="current_lang">
                    <div class="lang"><i class="flag-icon" :class="this.langIcon"></i><span class="lang-txt">{{ langLangauge }}</span></div>
                </div>

                <div class="more_lang" :class="{ 'active': isActive }">
                    <div class="lang" v-for="(l, index) in localOptions" :key="index">
                        <i class="flag-icon" :class="l.icon"></i><span class="lang-txt" @click="changeLocale(l)">{{
                            l.name }}<span>{{ l.short }} </span></span>
                    </div>
                </div>
